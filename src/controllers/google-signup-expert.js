...
const { signupGoogleExpert } = require("../integrations/google");
...
passport.use('signup-google-expert', signupGoogleExpert);
...
router.get('/', passport.authenticate('signup-google-expert', { state: '200' }));

router.get('/callback', passport.authenticate('signup-google-expert', {
  successRedirect: '/auth/expert/google/signup/success',
  failureRedirect: '/auth/expert/google/signup/failure'
}));
